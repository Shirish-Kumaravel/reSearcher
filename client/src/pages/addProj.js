...
function AddProj() {
    ...
    const addProject = () => {
        Axios.post("http://localhost:3001/addproject",{projID: projID, name: name, description: description,start_date: start_date,end_date: end_date,funding: funding}).then(()=>{
